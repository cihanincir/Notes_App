...
import 'package:notekeeper/helpers/color_converter.dart';
import 'package:share_plus/share_plus.dart';
import '../global.dart';
import 'package:google_fonts/google_fonts.dart';

import '../helpers/hello_world_example.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: "#A7FEEB".toColor(),
      appBar: AppBar(
        title: Text(
          "Notes",
        ...
        backgroundColor: "#F7BD02".toColor(),
        elevation: 0,
        actions: [
